...
! function(n, t) {
  "object" == typeof exports && "undefined" != typeof module ? t(exports, require("d3-array")) : "function" == typeof define && define.amd ? define(["exports", "d3-array"], t) : t(n.d3 = n.d3 || {}, n.d3)
}(this, function(n, t) {
  "use strict";
  ...
  var tn, rn, en, on, un, cn, an, ln, fn, sn, pn, hn, gn, vn, dn, En, yn, Sn, mn, Mn, xn, _n, Nn, wn, Rn, Cn, Pn = r(),
    An = {
      point: jn,
      lineStart: zn,
      lineEnd: bn,
    ...
    if (n.forEach(function(n) {
      ...
      for (var l, f, s = c[0];;) {
        ...
        do {
          if (p.v = p.o.v = !0, p.e) {
            if (h)
              for (o = 0, u = l.length; o < u; ++o) e.point((f = l[o])[0], f[1]);
            else i(p.x, p.n.x, 1, e);
            p = p.n
          } else {
            if (h)
              for (l = p.p.z, o = l.length - 1; o >= 0; --o) e.point((f = l[o])[0], f[1]);
  ...
  function ht(n, t) {
    ...
    for (var h = 0, g = n.length; h < g; ++h)
      if (y = (v = n[h]).length)
        for (var v, y, S = v[y - 1], m = S[0], M = S[1] / 2 + f, _ = x(M), N = E(M), w = 0; w < y; ++w, m = P, _ = j, N = q, S = R) {
          var R = v[w],
            P = R[0],
            A = R[1] / 2 + f,
            j = x(A),
    ...
    return function(o) {
      var u, c, a, l = r(o),
        ...
        h = {
          ...
          polygonEnd: function() {
            ...
            var n = ht(u, e);
            c.length ? (p || (o.polygonStart(), p = !0), ft(c, dt, n, i, o)) : n && (p || (o.polygonStart(), p = !0), o.lineStart(), i(null, null, 1, o), o.lineEnd()), p && (o.polygonEnd(), p = !1), c = u = null
          },
          sphere: function() {
      ...
      function m() {
        ...
        if (a.pop(), u.push(a), a = null, h)
          ...
          } else h > 1 && 2 & e && l.push(l.pop().concat(l.shift())), c.push(l.filter(vt))
      }
      return h
    }
  }
  ...
  var Et = gt(function() {
    ...
    var e;
    if (null == n) e = r * l, i.point(-a, e), i.point(0, e), i.point(a, e), i.point(a, 0), i.point(a, -e), i.point(0, -e), i.point(-a, -e), i.point(-a, 0), i.point(-a, e);
    else if (g(n[0] - t[0]) > u) {
      var o = n[0] < t[0] ? a : -a;
    ...
    return gt(o, function(n) {
      ...
      return {
        ...
        point: function(h, g) {
          ...
          if (!t && (s = f = E) && n.lineStart(), E !== f && (!(v = c(t, d)) || at(t, v) || at(d, v)) && (d[0] += u, d[1] += u, E = o(d[0], d[1])), E !== f) p = 0, E ? (n.lineStart(), v = c(d, t), n.point(v[0], v[1])) : (v = c(t, d), n.point(v[0], v[1]), n.lineEnd()), t = v;
          else if (e && t && i ^ E) {
            var S;
    ...
    return function(u) {
          ...
          polygonEnd: function() {
            var r = function() {
                for (var t = 0, r = 0, i = f.length; r < i; ++r)
                  for (var o, u, c = f[r], a = 1, l = c.length, s = c[0], p = s[0], h = s[1]; a < l; ++a) o = p, u = h, s = c[a], p = s[0], h = s[1], u <= e ? h > e && (p - o) * (e - u) > (h - u) * (n - o) && ++t : h <= e && (p - o) * (e - u) < (h - u) * (n - o) && --t;
                return t
              }(),
              i = S && r,
      ...
      function N(t, u) {
        ...
        if (f && s.push([t, u]), y) p = t, h = u, g = c, y = !1, c && (m.lineStart(), m.point(t, u));
          ...
          var a = [v = Math.max(mt, Math.min(St, v)), d = Math.max(mt, Math.min(St, d))],
            l = [t = Math.max(mt, Math.min(St, t)), u = Math.max(mt, Math.min(St, u))];
  ...
  function Dt() {
    var n, r, i, e, o, c, a, l, f, s, p, h, v = 10,
      d = v,
      E = 90,
      S = 360,
      m = 2.5;
    ...
    return M.lines = function() {
      ...
      return arguments.length ? (e = +n[0][0], i = +n[1][0], l = +n[0][1], a = +n[1][1], e > i && (n = e, e = i, i = n), l > a && (n = l, l = a, a = n), M.precision(m)) : [
        [e, l],
        [i, a]
      ]
    }, M.extentMinor = function(t) {
      return arguments.length ? (r = +t[0][0], n = +t[1][0], c = +t[0][1], o = +t[1][1], r > n && (t = r, r = n, n = t), c > o && (t = c, c = o, o = t), M.precision(m)) : [
        [r, c],
        [n, o]
      ]
    }, M.step = function(n) {
      ...
      return arguments.length ? (m = +t, f = Wt(c, o, 90), s = Bt(r, n, m), p = Wt(l, a, 90), h = Bt(e, i, m), M) : m
    }, M.extentMajor([
      [-180, -90 + u],
      [180, 90 - u]
    ]).extentMinor([
  ...
  var Xt, Yt, Zt, Jt, Kt = r(),
    ...
    Vt = {
      ...
      polygonEnd: function() {
        Vt.lineStart = Vt.lineEnd = Vt.point = A, Kt.add(g(Qt)), Qt.reset()
      },
      result: function() {
        var n = Kt / 2;
        return Kt.reset(), n
  ...
  var ar, lr, fr, sr, pr = 0,
    ...
    Mr = {
      ...
      result: function() {
        var n = mr ? [yr / mr, Sr / mr] : Er ? [vr / Er, dr / Er] : gr ? [pr / gr, hr / gr] : [NaN, NaN];
  ...
  function wr(n, t) {
    var r = n - fr,
      i = t - sr,
      e = N(r * r + i * i);
    vr += e * (fr + n) / 2, dr += e * (sr + t) / 2, Er += e, xr(fr = n, sr = t)
  }
  ...
  function jr(n, t) {
    var r = n - fr,
      i = t - sr,
      e = N(r * r + i * i);
    vr += e * (fr + n) / 2, dr += e * (sr + t) / 2, Er += e, yr += (e = sr * n - fr * t) * (fr + n), Sr += e * (sr + t), mr += 3 * e, xr(fr = n, sr = t)
  }
  ...
  function Hr(n, t) {
    Or -= n, Gr -= t, Tr.add(N(Or * Or + Gr * Gr)), Or = n, Gr = t
  }
  ...
  function Ur(n, t, r) {
    ...
    return n.scale(150).translate([0, 0]), null != i && n.clipExtent(null), O(r, n.stream(cr)), t(cr.result()), null != i && n.clipExtent(i), n
  }

  function Xr(n, t, r) {
    return Ur(n, function(r) {
      var i = t[1][0] - t[0][0],
        e = t[1][1] - t[0][1],
    ...
    point: function(n, t) {
      switch (this._point) {
        ...
        case 1:
          ...
          break;
        default:
          null == this._circle && (this._circle = Wr(this._radius)), this._string.push("M", n, ",", t, this._circle)
      }
    },
    result: function() {
      ...
      function r(i, e, o, c, a, l, f, s, p, h, v, E, y, S) {
        ...
        if (x > 4 * t && y--) {
          var _ = c + h,
            ...
            O = b - e,
            G = M * L - m * O;
          (G * G / x > t || g((m * L + M * O) / x - .5) > .3 || c * h + a * v + l * E < Qr) && (r(i, e, o, c, a, l, z, b, j, _ /= P, w /= P, R, y, S), S.point(z, b), r(z, b, j, _, w, R, f, s, p, h, v, E, y, S))
        }
      }
      return function(t) {
        ...
        function y(i, e) {
          var o = J([i, e]),
            u = n(i, e);
          r(f, s, l, p, h, g, f = u[0], s = u[1], l = i, p = o[0], h = o[1], g = o[2], Kr, t), t.point(f, s)
        }
        ...
        function x() {
          r(f, s, l, p, h, g, e, o, i, u, c, a, Kr, t), v.lineEnd = S, S()
        }
        return v
      }
    }(n, t) : function(n) {
  ...
  function ri(n) {
    ...
    function j() {
      ...
      return r = nt(y, S, m), c = Vn(t, i), a = Vn(r, c), u = Vr(c, C), q()
    }
    ...
    return P.stream = function(n) {
        ...
        return arguments.length ? (_ = +n ? yt(x = n * h) : (x = null, Et), q()) : x * p
      }, P.clipExtent = function(n) {
        return arguments.length ? (R = null == n ? (w = i = e = o = null, Ut) : Mt(w = +n[0][0], i = +n[0][1], e = +n[1][0], o = +n[1][1]), q()) : null == w ? null : [
          [w, i],
          [e, o]
        ]
      }, P.scale = function(n) {
  ...
  function oi() {
    return ii(ei).scale(155.424).center([0, 33.6442])
  }
  ...
  function pi(n) {
    ...
    return e.scale = function(n) {
      ...
      return arguments.length ? (null == n ? f = t = r = i = null : (f = +n[0][0], t = +n[0][1], r = +n[1][0], i = +n[1][1]), s()) : null == f ? null : [
        [f, t],
        [r, i]
      ]
    }, s()
  ...
  function xi(n, t) {
    var r = C(Mi * x(t)),
      i = r * r,
      e = i * i * i;
    return [n * E(r) / (Mi * (Ei + 3 * yi * i + e * (7 * Si + 9 * mi * i))), r * (Ei + yi * i + e * (Si + mi * i))]
  }
  ...
  xi.invert = function(n, t) {
    for (var r, i = t, e = i * i, o = e * e * e, u = 0; u < 12 && (o = (e = (i -= r = (i * (Ei + yi * e + o * (Si + mi * e)) - t) / (Ei + 3 * yi * e + o * (7 * Si + 9 * mi * e))) * i) * e * e, !(g(r) < c)); ++u);
    return [Mi * n * (Ei + 3 * yi * e + o * (7 * Si + 9 * mi * e)) / E(i), C(x(i) / Mi)]
  }, _i.invert = ai(v), wi.invert = function(n, t) {
    var r, i = t,
      e = 25;
    do {
      var o = i * i,
  ...
  }, Ri.invert = ai(C), Ci.invert = ai(function(n) {
    return 2 * v(n)
    ...
    return fn = sn = null, tn === 1 / 0 || rn === 1 / 0 ? [
      [NaN, NaN],
      [NaN, NaN]
    ] : [
      [tn, rn],
  ...
  }, n.geoClipAntimeridian = Et, n.geoClipCircle = yt, n.geoClipExtent = function() {
    var n, t, r, i = 0,
      e = 0,
      o = 960,
      u = 500;
    return r = {
      ...
      extent: function(c) {
        return arguments.length ? (i = +c[0][0], e = +c[0][1], o = +c[1][0], u = +c[1][1], n = t = null, r) : [
          [i, e],
          [o, u]
        ]
      }
    }
  }, n.geoClipRectangle = Mt, n.geoContains = function(n, t) {
    return (n && Lt.hasOwnProperty(n.type) ? Lt[n.type] : Gt)(n, t)
  }, n.geoDistance = bt, n.geoGraticule = Dt, n.geoGraticule10 = function() {
    return Dt()()
  ...
  }, n.geoLength = jt, n.geoPath = function(n, t) {
    var r, i, e = 4.5;
    ...
    return o.area = function(n) {
      ...
      return arguments.length ? (r = null == t ? (n = null, Ut) : (n = t).stream, o) : n
    }, o.context = function(n) {
      return arguments.length ? (i = null == n ? (t = null, new Ir) : new qr(t = n), "function" != typeof e && i.pointRadius(e), o) : t
    }, o.pointRadius = function(n) {
      return arguments.length ? (e = "function" == typeof n ? n : (i.pointRadius(+n), +n), o) : e
    }, o.projection(n).context(t)
  }, n.geoAlbers = ui, n.geoAlbersUsa = function() {
    var n, t, r, i, e, o, c = ui(),
      a = oi().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
      l = oi().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
      f = {
        point: function(n, t) {
          o = [n, t]
        }
    ...
    return s.invert = function(n) {
      ...
      var t = c.scale(),
        o = +n[0],
        s = +n[1];
      return r = c.translate(n).clipExtent([
        [o - .455 * t, s - .238 * t],
        [o + .455 * t, s + .238 * t]
      ]).stream(f), i = a.translate([o - .307 * t, s + .201 * t]).clipExtent([
        [o - .425 * t + u, s + .12 * t + u],
        [o - .214 * t - u, s + .234 * t - u]
      ]).stream(f), e = l.translate([o - .205 * t, s + .212 * t]).clipExtent([
        [o - .214 * t + u, s + .166 * t + u],
        [o - .115 * t - u, s + .234 * t - u]
      ]).stream(f), p()
    ...
    return ti(li).scale(124.75).clipAngle(179.999)
  }, n.geoAzimuthalEqualAreaRaw = li, n.geoAzimuthalEquidistant = function() {
    return ti(fi).scale(79.4188).clipAngle(179.999)
  }, n.geoAzimuthalEquidistantRaw = fi, n.geoConicConformal = function() {
    return ii(gi).scale(109.5).parallels([30, 30])
  }, n.geoConicConformalRaw = gi, n.geoConicEqualArea = oi, n.geoConicEqualAreaRaw = ei, n.geoConicEquidistant = function() {
    return ii(di).scale(131.154).center([0, 13.9389])
  }, n.geoConicEquidistantRaw = di, n.geoEqualEarth = function() {
    return ti(xi).scale(177.158)
  }, n.geoEqualEarthRaw = xi, n.geoEquirectangular = function() {
    return ti(vi).scale(152.63)
  }, n.geoEquirectangularRaw = vi, n.geoGnomonic = function() {
    return ti(_i).scale(144.049).clipAngle(60)
  }, n.geoGnomonicRaw = _i, n.geoIdentity = function() {
    var n, t, r, i, e, o, u = 1,
      c = 0,
      a = 0,
      l = 1,
    ...
    return o = {
      ...
      clipExtent: function(i) {
        return arguments.length ? (h = null == i ? (p = n = t = r = null, Ut) : Mt(p = +i[0][0], n = +i[0][1], t = +i[1][0], r = +i[1][1]), g()) : null == p ? null : [
          [p, n],
          [t, r]
        ]
      },
      scale: function(n) {
        return arguments.length ? (s = Ni((u = +n) * l, u * f, c, a), g()) : u
      },
      translate: function(n) {
        return arguments.length ? (s = Ni(u * l, u * f, c = +n[0], a = +n[1]), g()) : [c, a]
      },
      reflectX: function(n) {
        return arguments.length ? (s = Ni(u * (l = n ? -1 : 1), u * f, c, a), g()) : l < 0
      },
      reflectY: function(n) {
        return arguments.length ? (s = Ni(u * l, u * (f = n ? -1 : 1), c, a), g()) : f < 0
      },
  ...
  }, n.geoProjection = ti, n.geoProjectionMutator = ri, n.geoMercator = function() {
    return pi(si).scale(961 / s)
  }, n.geoMercatorRaw = si, n.geoNaturalEarth1 = function() {
    return ti(wi).scale(175.295)
  }, n.geoNaturalEarth1Raw = wi, n.geoOrthographic = function() {
    return ti(Ri).scale(249.5).clipAngle(90 + u)
  }, n.geoOrthographicRaw = Ri, n.geoStereographic = function() {
    return ti(Ci).scale(250).clipAngle(142)
  }, n.geoStereographicRaw = Ci, n.geoTransverseMercator = function() {
    var n = pi(Pi),
      t = n.center,
      r = n.rotate;
  ...
  }, n.geoTransverseMercatorRaw = Pi, n.geoRotation = et, n.geoStream = O, n.geoTransform = function(n) {
    return {
      stream: Br(n)
    }
